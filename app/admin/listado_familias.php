...
<head>
    ...
    <title>Agregar Familia | Miapp</title>
        ...
        <div class="page-wrapper">
            <div class="content">
                <form id="taskForm">
                    ...
                    <div class="card-box">
                        <h3 class="card-title">Agregar Familia</h3>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" id="nom_cate" name="nom_cate" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-sm-12">
                        <div class="card-box">
                            <div class="card-block">
                                <h6 class="page-title">Listado de Familias</h6>
                                <div class="table-responsive">
                                    <table id="tbl_categoria" class="datatable table table-stripped ">
                                        <thead>
                                            <tr>
