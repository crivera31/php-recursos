			...
			if(name.length > 0){
				$.ajax({
					...
					success: function(data){
						$('#formChat table tr').html('<td width="90%"><input type="text" placeholder="Escribe un mensaje..." id="message" autocomplete="off"></td><td><input type="submit" id="submit" value="Enviar"></td>')
